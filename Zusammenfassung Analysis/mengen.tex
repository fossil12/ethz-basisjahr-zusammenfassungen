...
\begin{description}
	\item[$\N$, natürliche Zahlen:] $\{0, 1, 2, 3, \ldots\}$
...
Abgeschlossene beschränkte Intervalle sind \underline{kompakt}.
...
Gleiche Elemente werden nur einmal gezählt: $\{1,2,3\} = \{1,2,3,2,3\}$
...
\right.
\end{equation*}
\todo{$U$ kann doch nach Def. gar nicht negtiv sein...?} 
% Todo: kann doch nach Def. gar nicht negtiv sein...? (DK)
% f(1) = 1
% f(2) = -3
% f(3) = 3
% (andere Lsg suchen, um dies zu beweisen)
