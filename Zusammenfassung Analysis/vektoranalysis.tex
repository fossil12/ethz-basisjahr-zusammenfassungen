...
\begin{itemize}
	\item Skalarfunktion: $f: \R^n \rightarrow \R$ mit $n \geq 1$
	\item Paramertrisierung: $f: \R \rightarrow \R^n$ mit $n \geq 1$
	\item Vektorfeld: $f: \R^n \rightarrow \R^m$ mit $n, m \geq 1$
\end{itemize}
...
%\begin{definition}[Rotor / Rotation] Nicht Prüfungsstoff
...
%\end{definition}
%
%\begin{definition}[Vektorpotential] (vermutlich) nicht Prüfungsstoff
%Ein Vektorfeld $\vec{v}$ heisst Vektorpotential zu $\vec{w}$, falls $\vec{w} = \rot \vec{v}$.
%\end{definition}
%
%\begin{definition}[Wirbelfrei / konservativ] (vermutlich) nicht Prüfungsstoff
...
\todo{Divergenzsatz / Satz von Gauss | Richtungsgleichung?}
% Todo: Divergenzsatz / Satz von Gauss | Richtungsgleichung?
